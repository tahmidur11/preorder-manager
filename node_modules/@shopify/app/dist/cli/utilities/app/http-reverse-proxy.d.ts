 ...
 */
export declare function runConcurrentHTTPProcessesAndPathForwardTraffic(portNumber: number | undefined, proxyTargets: ReverseHTTPProxyTarget[], additionalProcesses: output.OutputProcess[]): Promise<void>;
