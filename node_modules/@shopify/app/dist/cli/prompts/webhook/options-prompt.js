import { addressPrompt, apiVersionPrompt, deliveryMethodInstructions, deliveryMethodPrompt, sharedSecretPrompt, topicPrompt, } from './trigger.js';
...
export async function collectSecret(sharedSecret) {
