...
export declare type FunctionConfigType = schema.infer<typeof BaseFunctionConfigurationSchema>;
/**
...
export declare class FunctionInstance<TConfiguration extends FunctionConfigType = FunctionConfigType> implements FunctionExtension {
    ...
    inputQueryPath(): any;
    buildWasmPath(): any;
    build(stdout: Writable, stderr: Writable, signal: AbortSignal): Promise<void>;
    publishURL(options: {
        orgId: string;
        appId: string;
    }): Promise<string>;
