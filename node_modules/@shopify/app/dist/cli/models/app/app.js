...
const WebConfigurationAuthCallbackPathSchema = schema.preprocess((arg) => (typeof arg === 'string' && !arg.startsWith('/') ? `/${arg}` : arg), schema.string());
...
export class App {
    ...
    extensionsForType(specification) {
        ...
        return allExternsions.filter((extension) => extension.type === specification.identifier || extension.type === specification.externalIdentifier);
    }
}
/**
