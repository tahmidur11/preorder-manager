 ...
 */
export declare function getWebhookSample(token: string, topic: string, apiVersion: string, deliveryMethod: string, address: string, sharedSecret: string): Promise<SampleWebhook>;
export {};
