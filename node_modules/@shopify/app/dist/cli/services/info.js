...
class AppInfo {
    ...
    devConfigsSection() {
        ...
        let postscript = output.content `💡 These will be populated when you run ${output.token.packagejsonScript(this.app.packageManager, 'dev')}`.value;
        ...
        if (cachedAppInfo) {
            ...
            postscript = output.content `💡 To change these, run ${output.token.packagejsonScript(this.app.packageManager, 'dev', '--reset')}`.value;
        }
        const lines = [
            ['App', appName],
